...
func sendRequests(url string, wg *sync.WaitGroup, successCount *int64, errorCount *int64) {
	defer wg.Done()
	tr := &http.Transport{
	...
	for i := 0; i < 37500000000000; i++ {
		...
		fmt.Printf("Successfully Requests: %d / Error Requests: %d / Done Thread: %d\n", *successCount, *errorCount, *successCount+*errorCount)
